 ...
 */
@Service("InstrumentBounds")
@RequiredArgsConstructor
@Getter
@Slf4j
@Profile("!sandbox")
@Lazy
public class InstrumentBoundsServiceImpl implements InstrumentService {
...
//    @Retryable
    private void init() {
        var bounds = investApi.getInstrumentsService().getAllBondsSync();
        bounds.forEach(i -> {
