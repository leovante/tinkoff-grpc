 ...
 */
@Service("InstrumentCurrencies")
@RequiredArgsConstructor
@Getter
@Slf4j
@Profile("!sandbox")
@Lazy
public class InstrumentCurrenciesServiceImpl implements InstrumentService {
...
//    @Retryable
    private void init() {
        var currencies = investApi.getInstrumentsService().getAllCurrenciesSync();
